    ...
    <div class="panel box-shadow-none content-header">
        <div class="panel-body">
            <div class="col-md-12">
                ...
                Administrador <span class="fa-angle-right fa"></span> Parqueadero
                </p>
            </div>
        </div>
    </div>
...
<tr>
    ...
    <td> @switch($parqueadero->ESTADO_PARQUEADERO)
        ...
        <td> @switch($parqueadero->OCUPADO)
            ...
            @endswitch</td>
    <td>
        <a href="{{route('parqueadero.form',['id'=>$parqueadero->id])}}" class="btn btn-info" style="margin-top: 8px;"><i class="icon-note"></i></a>
    </td>
    <td>

        <button type="button" class="btn btn-danger" style="margin-top: 8px;"   data-toggle="modal" data-target="{{'#deleteModal'. $parqueadero->{'id'} }}"><i class="las la-parking" style="font-size:23px;"></i><i class="icon-close" style="font-size:17px;"></i></button>
