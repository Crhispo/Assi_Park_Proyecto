...
.anulada{
    ...
    <table id="factura_head">
		<tr>
			...
			<td class="info_empresa">
				<div>
					<span class="h2">REPORTE DE USUARIOS</span><br>
  ...
  <thead>
    <tr>
      ...
      <th scope="col" class="textleft">Dirección</th>
      <th scope="col" class="textleft">Teléfono</th>
  ...
  <tbody>
      @foreach($usu as $user)
    <tr>
      <th scope="row">{{$user->NUMERO_IDENTIFICACION }}</th>
