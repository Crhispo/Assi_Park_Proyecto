...
<head>
    ...
    <div class="d-flex">
        <div id="sidebar-container" style="Background-color:#f5f6f8;">
            ...
            <div class="menu">
                <a href="{{ route('usuario.index') }}" class="d-block text-dark p-3"><i
                        class="icon ion-md-contacts mr-2 lead"></i>Usuarios</a>
                ...
                <a href="{{ route('parqueadero.show') }}" class="d-block text-dark p-3"><i
                        class="icon ion-md-grid mr-2 lead"></i>Parqueaderos</a>
                <a href="{{ route('vehiculo.show') }}" class="d-block text-dark p-3"><i
                        class="icon ion-md-car mr-2 lead"></i>Vehiculos</a>
            </div>
        </div>
